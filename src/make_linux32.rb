...
$pin_path="./pin/"
$lua_path="./lua/"
$pin_include_paths = %w{InstLib source/include/pin source/include/pin/gen extras/components/include extras/xed2-ia32/include }
...
$lib_paths = $pin_lib_paths.map{|p| $pin_path+p}+[$lua_path+"lib"]+["/usr/lib/i386-linux-gnu/"]

$ccflags ="-DBIGARRAY_MULTIPLIER=1 -DUSING_XED -Wall -Werror -DTARGET_IA32 -DHOST_IA32 -fPIC -DTARGET_LINUX -O3 -fomit-frame-pointer -fno-strict-aliasing -g -m32"

$ldflags = "-shared -Wl,--hash-style=sysv -Wl,-Bsymbolic -Wl,--version-script=../../../source/include/pin/pintool.ver -g -m32"
